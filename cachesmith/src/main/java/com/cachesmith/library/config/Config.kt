...
object Config {
	...
	const val MANUAL_VERSION_KEY = "cache-smith-manual-version-key"
	const val VERSION_CACHED_KEY = "cache-smith-db-version-key"
	const val DB_NAME_KEY = "cache-smith-db-name-key"
}